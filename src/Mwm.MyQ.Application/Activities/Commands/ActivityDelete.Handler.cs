...
namespace Mwm.MyQ.Application.Activities.Commands {
    ...
    //        private readonly IRepository<Activity> _tskRepository;

    //        public Handler(ILogger<Handler> logger,
    //                       IRepository<Activity> tskRepository) {
    //            _logger = logger;
    //            _activityRepository = tskRepository;
    //        }
