...
namespace Mwm.Asanate.Application.Tsks.Commands {
    ...
    public class AddTskCommand : IRequest<Result> {
    ...
    public class Handler : RequestHandler<AddTskCommand, Result> {
        ...
        protected override Result Handle(AddTskCommand command) {
        ...
        private Result<int> FindOrCreateInitiative(AddTskCommand command) {
            try {
        ...
        private Result<int> CreateTsk(AddTskCommand command, int initiativeId) {
            try {
                var tsk = new Tsk {
                    Name = command.Name,
